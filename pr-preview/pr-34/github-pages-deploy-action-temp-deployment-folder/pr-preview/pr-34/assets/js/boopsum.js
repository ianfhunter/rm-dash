(function () {
  ...
  function getSelectedEffortIndex() {
    var val = Number(form.questTuning && form.questTuning.value);
  ...
  calcBtn.addEventListener("click", function () {
    ...
    var gpByPlayer = PArr.map(function (x, i) {
      return Math.floor((XPArr[i] / HalfProf[x]) * effort.mod * GPMod[x]);
    });
    ...
    lootLogEl.textContent = lootLogMarkdown(PlayerXP, questType.givesGold ? gpByPlayer : [0], party, questType.label, effort.label);
